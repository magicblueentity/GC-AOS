#!/usr/bin/env python3
"""
Convert toolbar PNG icons to C arrays for GC AOS kernel.
...
def render_rotate_cw(size):
    ...
    draw.polygon(
        [(size - 6, 6), (size - 3, 10), (size - 10, 8)], fill=(255, 255, 255, 255)
    )
    return img
...
def render_fullscreen(size):
    ...
    # Top-right corner
    draw.line(
        [(size - 9, 2), (size - 3, 2), (size - 3, 8)],
        fill=(255, 255, 255, 255),
        width=2,
    )
    # Bottom-left corner
    draw.line(
        [(2, size - 9), (2, size - 3), (8, size - 3)],
        fill=(255, 255, 255, 255),
        width=2,
    )
    # Bottom-right corner
    draw.line(
        [(size - 9, size - 3), (size - 3, size - 3), (size - 3, size - 9)],
        fill=(255, 255, 255, 255),
        width=2,
    )
    return img
